<template>
  <div class="dash">
    <div class="hero">
      ...
      <p class="sub">五大智能体协同:问答 · 智能教学 · 智能评估 · 智能教具 · 智能科研。选择一个开始工作。</p>
    </div>
...
const modules = [
  ...
  { path: '/teaching', icon: '📚', title: '智能教学', desc: '据定稿 IEP 生成教案与课件草案,人工定稿', roles: ['SUPER_ADMIN', 'TEACHER'] },
  { path: '/diagnosis', icon: '🩺', title: '智能评估', desc: '多模态诊断(文本/图片/视频/语音)→ IEP 干预计划 → 训练对比评估,聚焦特殊儿童康复', roles: ['SUPER_ADMIN', 'TEACHER'] },
  { path: '/aids', icon: '🧩', title: '智能教具', desc: '按障碍类型推荐教具,文生教学素材(插图/绘本/音视频)', roles: ['SUPER_ADMIN', 'TEACHER'] },
  { path: '/research', icon: '🔬', title: '智能科研', desc: '课题申报书生成,量表信效度(Cronbach α)计算', roles: ['SUPER_ADMIN', 'TEACHER'] }
]
