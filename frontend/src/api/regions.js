// 省 - 主要地市级联数据(前端内置,精简版:覆盖主要地市,非县区全量)。
// 数据源可热插拔:后续替换为完整行政区划只需替换本文件导出结构。
export const PROVINCES = [
  { name: '北京市', cities: ['北京市'] },
  { name: '天津市', cities: ['天津市'] },
  { name: '上海市', cities: ['上海市'] },
  { name: '重庆市', cities: ['重庆市'] },
  { name: '河北省', cities: ['石家庄市', '唐山市', '保定市', '邯郸市', '秦皇岛市', '张家口市', '承德市', '沧州市', '廊坊市', '衡水市', '邢台市'] },
  ...
  { name: '辽宁省', cities: ['沈阳市', '大连市', '鞍山市', '抚顺市', '本溪市', '丹东市', '锦州市', '营口市', '盘锦市', '铁岭市', '朝阳市', '葫芦岛市'] },
  { name: '吉林省', cities: ['长春市', '吉林市', '四平市', '辽源市', '通化市', '白山市', '松原市', '白城市', '延边朝鲜族自治州'] },
  { name: '黑龙江省', cities: ['哈尔滨市', '齐齐哈尔市', '鸡西市', '鹤岗市', '大庆市', '伊春市', '佳木斯市', '牡丹江市', '绥化市'] },
  ...
  { name: '台湾省', cities: ['台北市', '高雄市', '台中市', '台南市', '新北市'] },
