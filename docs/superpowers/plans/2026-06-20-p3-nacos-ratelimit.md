...
- [ ] **Step 1: backend/pom.xml 加两个 BOM 到 dependencyManagement**
...
- [ ] **Step 2: backend/pom.xml 加 nacos-discovery 依赖**
...
- [ ] **Step 3: backend 主 application.yml 改服务名 + 加 nacos**
...
- [ ] **Step 4: backend test profile 禁 discovery**
...
- [ ] **Step 5: backend dev profile 加 nacos server-addr**
...
- [ ] **Step 7: 验证 backend 237 全绿(无 Nacos 运行)**
...
- [ ] **Step 8: 验证网关 contextLoads(lb 路由 + 无 Nacos)**
...
- [ ] **Step 5: 实现 RateLimitGatewayFilter**
...
- [ ] **Step 6: GatewayApplication 注册 RateLimitProperties**
...
- [ ] **Step 7: 网关 application.yml 加 redis + rate-limit 配置**
...
- [ ] **Step 2: 确认 backend 接入 Nacos 但测试不连(已在 Task1 验证,这里复核全量)**
