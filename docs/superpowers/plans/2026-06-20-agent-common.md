...
- [x] **Step 1: 创建 sellm-agent-common/pom.xml**
...
- [x] **Step 2: 根 pom 注册模块 + dependencyManagement**
...
- [x] **Step 3: 创建 SmartLayerException + UnauthorizedException**
...
- [x] **Step 4: 创建 SmartLayerProperties**
...
- [x] **Step 5: 创建 AbstractHttpSmartLayerClient**
...
- [x] **Step 6: 创建 AgentExceptionHandler**
...
- [x] **Step 7: 创建 AgentCommonAutoConfiguration + imports**
...
- [x] **Step 8: 写测试 AbstractHttpSmartLayerClientTest(传输层)**
...
- [x] **Step 9: 验证 sellm-agent-common 独立编译 + 测试**
...
- [x] **Step 1: qa pom 加 sellm-agent-common 依赖**
...
- [x] **Step 3: HttpSmartLayerClient 改继承 AbstractHttpSmartLayerClient**
...
- [x] **Step 4: QaAppService 改 import + topK 本地常量**
...
- [x] **Step 7: qa application.yml 改配置键**
...
- [x] **Step 1: teaching pom 加 sellm-agent-common 依赖**
...
- [x] **Step 3: HttpSmartLayerClient 改继承基类**
...
- [x] **Step 4: TeachingAppService + Controllers + Application 改 import / 去注解**
...
- [x] **Step 5: teaching application.yml 改配置键**
...
- [x] **Step 6: 验证 teaching 15 测试全绿(clean)**
...
- [x] **Step 1: 全 reactor clean install(10 模块)**
