...
- [x] **Step 1: 加依赖到 sellm-agent-research/pom.xml**
...
- [x] **Step 4: 写失败测试 ResearchRepositoryTest**
...
- [x] **Step 7: 创建实体 ResearchProposal**
...
- [x] **Step 1: 写失败测试 ReliabilityServiceTest(对标已知值)**
...
- [x] **Step 4: 实现 ReliabilityService**
...
- [x] **Step 4: 创建 SmartLayerClient 接口 + HttpResearchSmartLayerClient**
...
- [x] **Step 5: 实现 ReliabilityAppService + ReliabilityController**
...
- [x] **Step 6: 实现 ProposalAppService + ProposalController(镜像 teaching)**
...
- [x] **Step 1: 写失败测试 test_research.py**
...
- [x] **Step 3: 实现 agents/research.py**
...
- [x] **Step 4: main.py 加 research 端点**
